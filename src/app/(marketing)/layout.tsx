      ...
      <header className="border-b border-slate-200 bg-white/95 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/">
            ...
            <img src="/stactoro-logo.svg" alt="Stactoro" style={{ height: 40, width: "auto", objectFit: "contain" }} />
          </Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="mb-4">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/stactoro-logo.svg" alt="Stactoro" style={{ height: 32, width: "auto", objectFit: "contain" }} />
              </div>
